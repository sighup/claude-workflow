...
Task({
  ...
  prompt: "Generate Gherkin BDD scenarios for this spec. --spec docs/specs/[NN]-spec-[feature-name]/[NN]-spec-[feature-name].md. Read protocol at: skills/cw-gherkin/SKILL.md. This is an automated call from cw-spec — skip Phase 4 (task stubs offer) and return after saving gherkin.md."
})
```

This runs silently. Once complete, note in the Step 6 review that `gherkin.md` was also created alongside the spec.
