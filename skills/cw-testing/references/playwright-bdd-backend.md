...
└── testing/                       artifacts_dir
    ...
    └── .features-gen/             transient — add to .gitignore
```
...
### .features-gen/ not gitignored
The `.features-gen/` directory is auto-generated by `bddgen` on every run. Add it to `.gitignore`:
```
docs/specs/**/testing/.features-gen/
```
