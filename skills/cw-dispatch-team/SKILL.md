...
description: "Persistent agent team dispatcher with lead coordination. Use after cw-plan to execute tasks via a managed team (requires CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1 and CLAUDE_CODE_TASK_LIST_ID)."
user-invocable: true
...
- **If FAIL**: Show blocking issues and recommend running `/cw-dispatch-team` again after fixes
