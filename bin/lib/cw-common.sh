...
# Worktree Management
# =============================================================================
# provision_worktree, cw_worktree_names, and create_worktree have been
# relocated to scripts/lib/cw-common.sh (single source of truth).
# Source that file here so bin/ scripts continue to work unchanged.
# shellcheck source=../../scripts/lib/cw-common.sh
source "$(dirname "${BASH_SOURCE[0]}")/../../scripts/lib/cw-common.sh"
